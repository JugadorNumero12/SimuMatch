...
public final class Gui {
    ...
    private final AbilitiesData data;

    private final Equipo e1;

    private final Equipo e2;

    private Partido match;

    private Turno turn;

    private final HashMap<Action, Number> prepHashL, prepHashV, matchHashL, matchHashV;

    private final JSpinner[] arraySpinsP;

    private final JSpinner[] arraySpinsM;
    ...
    public static void main (String[] args) {
        /*
         * try { UIManager.setLookAndFeel("javax.swing.plaf.nimbus.NimbusLookAndFeel"); } catch (Throwable e) {
         * e.printStackTrace(); }
         */
        try {
    ...
    private Gui () {
        ...
        arraySpinsP =
            new JSpinner[] {
                spinner, spinner_1, spinner_2, spinner_3, spinner_4, spinner_5, spinner_6, spinner_7, spinner_8,
                spinner_9, spinner_10, spinner_11, spinner_12, spinner_13, spinner_14, spinner_15, spinner_16,
                spinner_17, spinner_18, spinner_19, spinner_20, spinner_21, spinner_22, spinner_23, spinner_24,
                spinner_25, spinner_26, spinner_27, spinner_28, spinner_29};
        arraySpinsM =
            new JSpinner[] {
                spinner_30, spinner_31, spinner_32, spinner_33, spinner_34, spinner_35, spinner_36, spinner_37,
                spinner_38, spinner_39, spinner_40, spinner_41, spinner_42, spinner_43, spinner_44, spinner_45,
                spinner_46, spinner_47, spinner_48, spinner_49};
    ...
    private void initialize () {
        ...
        frmJugadorNumero.setIconImage(Toolkit.getDefaultToolkit().getImage(
            Gui.class.getResource("/simumatch/gui/numero12.png")));
        ...
        panel.setBorder(new TitledBorder(
            null, "Variables de entrada", TitledBorder.LEADING, TitledBorder.TOP, null, null));

        panel_1 = new JPanel();
        panel_1
            .setBorder(new TitledBorder(null, "Salida generada", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.TRAILING).addGroup(
            groupLayout.createSequentialGroup().addComponent(panel, GroupLayout.DEFAULT_SIZE, 861, Short.MAX_VALUE)
        ...
        panel_4.setBorder(new TitledBorder(
            null, "Registro de valores generados", TitledBorder.LEADING, TitledBorder.TOP, null, null));

        panel_5 = new JPanel();
        panel_5
            .setBorder(new TitledBorder(null, "Resultado actual", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        gl_panel_1.setVerticalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addGroup(
            gl_panel_1.createSequentialGroup()
                ...
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(panel_5, GroupLayout.DEFAULT_SIZE, 113, Short.MAX_VALUE).addContainerGap()));
        ...
        gl_panel_5
            .setHorizontalGroup(gl_panel_5
                ...
                .addGroup(
                    Alignment.TRAILING,
                    gl_panel_5.createSequentialGroup().addContainerGap(191, Short.MAX_VALUE)
        ...
        gl_panel_4.setHorizontalGroup(gl_panel_4.createParallelGroup(Alignment.LEADING).addComponent(
            scrollPane, GroupLayout.DEFAULT_SIZE, 363, Short.MAX_VALUE));
        gl_panel_4.setVerticalGroup(gl_panel_4.createParallelGroup(Alignment.LEADING).addComponent(
            scrollPane, GroupLayout.DEFAULT_SIZE, 382, Short.MAX_VALUE));
        ...
        panel_2.setBorder(new TitledBorder(
            null, "Modificadores de preparativos", TitledBorder.LEADING, TitledBorder.TOP, null, null));

        panel_3 = new JPanel();
        panel_3.setBorder(new TitledBorder(
            null, "Acciones inmediatas", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        gl_panel.setHorizontalGroup(gl_panel
            ...
            .addGroup(
                ...
                gl_panel.createSequentialGroup().addContainerGap()
                    .addComponent(panel_2, GroupLayout.PREFERRED_SIZE, 757, Short.MAX_VALUE).addContainerGap()));
        gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.TRAILING).addGroup(
            gl_panel.createSequentialGroup().addContainerGap()
                .addComponent(panel_2, GroupLayout.DEFAULT_SIZE, 302, Short.MAX_VALUE).addGap(12)
            ...
            gl_panel_3
                    ...
                    gl_panel_3
                        ...
                        .addGroup(
                            gl_panel_3
                                .createSequentialGroup()
                                .addComponent(
                                    spinner_30, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                        ...
                        .addGroup(
                            gl_panel_3
                                .createSequentialGroup()
                                .addComponent(
                                    spinner_31, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                    GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(ComponentPlacement.RELATED)
                                .addComponent(
                                    lblIniciarOla, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE))
                        .addGroup(
                            gl_panel_3
                                .createSequentialGroup()
                                .addComponent(
                                    spinner_32, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                    GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(ComponentPlacement.RELATED)
                                .addComponent(
                                    lblPunteroLaser, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE))
                        .addGroup(
                            gl_panel_3
                                .createSequentialGroup()
                                .addComponent(
                                    spinner_33, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                    GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(ComponentPlacement.RELATED)
                                .addComponent(
                                    lblTirarVengala, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE))
                        .addGroup(
                            gl_panel_3
                                .createSequentialGroup()
                                .addComponent(
                                    spinner_34, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                    GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(ComponentPlacement.RELATED)
                                .addComponent(
                                    lblBeberCerveza, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE)))
                .addGap(22)
                .addGroup(
                    gl_panel_3
                        .createParallelGroup(Alignment.LEADING)
                        .addGroup(
                            gl_panel_3
                                ...
                                .addPreferredGap(ComponentPlacement.RELATED)
                                .addComponent(
                                    lblActivarSoborno, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE))
                        .addGroup(
                            gl_panel_3
                                .createSequentialGroup()
                                ...
                                .addPreferredGap(ComponentPlacement.RELATED)
                                .addComponent(
                                    lblHablarSpeaker, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE))
                        .addGroup(
                            gl_panel_3
                                .createSequentialGroup()
                                ...
                                .addPreferredGap(ComponentPlacement.RELATED)
                                .addComponent(
                                    lblRetransmision, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE))
                        .addGroup(
                            gl_panel_3
                                .createSequentialGroup()
                                ...
                                .addPreferredGap(ComponentPlacement.RELATED)
                                .addComponent(
                                    lblEntrevistaDesc, GroupLayout.PREFERRED_SIZE, 101, GroupLayout.PREFERRED_SIZE))
                        .addGroup(
                            gl_panel_3
                                .createParallelGroup(Alignment.LEADING)
                                ...
                                .addGroup(
                                    gl_panel_3
                                        .createSequentialGroup()
                                        .addComponent(
                                            spinner_39, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addComponent(
                                            lblDoblarApuesta, GroupLayout.PREFERRED_SIZE, 101,
                                            GroupLayout.PREFERRED_SIZE))))
                ...
                .addGroup(
                    gl_panel_3
                        ...
                        .addGroup(
                            gl_panel_3.createSequentialGroup().addGap(167).addComponent(lblEquipoVisitante_1)
                                .addGap(48)
                                    ...
                                    gl_panel_3
                                        ...
                                        .addGroup(
                                            gl_panel_3
                                                .createParallelGroup(Alignment.LEADING)
                                                .addComponent(
                                                    spinner_40, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addGroup(
                                                    gl_panel_3
                                                        .createSequentialGroup()
                                                        .addGap(6)
                                                        .addComponent(
                                                            label_9, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE))
                                                .addComponent(
                                                    spinner_45, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addGroup(
                                                    gl_panel_3
                                                        .createSequentialGroup()
                                                        .addGap(6)
                                                        .addComponent(
                                                            label_10, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE)))
                                        .addGap(6)
                                        .addGroup(
                                            gl_panel_3
                                                .createParallelGroup(Alignment.LEADING)
                                                .addComponent(
                                                    spinner_41, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addGroup(
                                                    gl_panel_3
                                                        .createSequentialGroup()
                                                        .addGap(6)
                                                        .addComponent(
                                                            label_11, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE))
                                                .addComponent(
                                                    spinner_46, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addGroup(
                                                    gl_panel_3
                                                        .createSequentialGroup()
                                                        .addGap(6)
                                                        .addComponent(
                                                            label_15, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE)))
                                        .addGap(6)
                                        .addGroup(
                                            gl_panel_3
                                                .createParallelGroup(Alignment.LEADING)
                                                .addComponent(
                                                    spinner_42, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addGroup(
                                                    gl_panel_3
                                                        .createSequentialGroup()
                                                        .addGap(6)
                                                        .addComponent(
                                                            label_12, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE))
                                                .addComponent(
                                                    spinner_47, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addGroup(
                                                    gl_panel_3
                                                        .createSequentialGroup()
                                                        .addGap(6)
                                                        .addComponent(
                                                            label_16, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE)))
                                        .addGap(6)
                                        .addGroup(
                                            gl_panel_3
                                                .createParallelGroup(Alignment.LEADING)
                                                .addComponent(
                                                    spinner_43, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addGroup(
                                                    gl_panel_3
                                                        .createSequentialGroup()
                                                        .addGap(6)
                                                        .addComponent(
                                                            label_13, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE))
                                                .addComponent(
                                                    spinner_48, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addGroup(
                                                    gl_panel_3
                                                        .createSequentialGroup()
                                                        .addGap(6)
                                                        .addComponent(
                                                            label_17, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE)))
                                        .addGap(6)
                                        .addGroup(
                                            gl_panel_3
                                                .createParallelGroup(Alignment.LEADING)
                                                .addComponent(
                                                    spinner_44, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addGroup(
                                                    gl_panel_3
                                                        .createSequentialGroup()
                                                        .addGap(6)
                                                        .addComponent(
                                                            label_14, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE))
                                                .addComponent(
                                                    spinner_49, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addGroup(
                                                    gl_panel_3
                                                        .createSequentialGroup()
                                                        .addGap(6)
                                                        .addComponent(
                                                            label_18, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE)))
                                        .addGap(31)
                                        .addComponent(
                                            lblEquipoVisitante_1, GroupLayout.PREFERRED_SIZE, 15,
                                            GroupLayout.PREFERRED_SIZE))
                                .addGroup(
                                    gl_panel_3
                                        .createSequentialGroup()
                                        .addGroup(
                                            gl_panel_3
                                                ...
                                                .addComponent(lblNewLabel)
                                                .addComponent(
                                                    spinner_35, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblEntrevistaDesc, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_3
                                                ...
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_36, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblIniciarOla, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblRetransmision, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_3
                                                ...
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_37, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblPunteroLaser, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblHablarSpeaker, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_3
                                                ...
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_38, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblTirarVengala, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblActivarSoborno, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_3
                                                ...
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblBeberCerveza, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_39, GroupLayout.PREFERRED_SIZE, 26,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblDoblarApuesta, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addGap(31)
                                        .addComponent(
                                            label_8, GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE)))
                        .addContainerGap(45, Short.MAX_VALUE))
                .addGroup(
                    Alignment.TRAILING,
                    gl_panel_3.createSequentialGroup().addContainerGap(229, Short.MAX_VALUE)
                                    ...
                                    gl_panel_2
                                        ...
                                        .addGroup(
                                            gl_panel_2
                                                .createParallelGroup(Alignment.LEADING)
                                                .addComponent(
                                                    spinner, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_3, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_4, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    lblPintarse, GroupLayout.PREFERRED_SIZE, 57,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblPelea, GroupLayout.PREFERRED_SIZE, 57,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblPancarta, GroupLayout.PREFERRED_SIZE, 57,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblPromocionarEquipo, GroupLayout.PREFERRED_SIZE, 57,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addGap(18)
                                        .addGroup(
                                            gl_panel_2
                                                .createParallelGroup(Alignment.LEADING)
                                                .addComponent(
                                                    spinner_5, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_6, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_7, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_8, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_9, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    lblOrgCena, GroupLayout.PREFERRED_SIZE, 57,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addGroup(
                                                    gl_panel_2
                                                        .createParallelGroup(Alignment.TRAILING, false)
                                                        .addComponent(
                                                            lblFinanciacin, Alignment.LEADING,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                                            Short.MAX_VALUE)
                                                        .addComponent(
                                                            lblRrppNuevo, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                        .addComponent(
                                                            lblOrgHomenaje, Alignment.LEADING,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                                            Short.MAX_VALUE)))
                                        .addGap(18)
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    spinner_10, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addGroup(
                                                    gl_panel_2
                                                        .createParallelGroup(Alignment.LEADING)
                                                        .addComponent(
                                                            spinner_11, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(
                                                            spinner_12, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(
                                                            spinner_13, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(
                                                            spinner_14, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    lblMejorargradas, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addComponent(
                                                    lblSoborno, GroupLayout.PREFERRED_SIZE, 57,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblIncentivo, GroupLayout.PREFERRED_SIZE, 57,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblApostar, GroupLayout.PREFERRED_SIZE, 57,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblAscenderTr, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    Short.MAX_VALUE)))
                                .addGroup(gl_panel_2.createSequentialGroup().addGap(155).addComponent(lblEquipoLocal)))
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addGroup(
                            gl_panel_2
                                .createParallelGroup(Alignment.LEADING)
                                    ...
                                    gl_panel_2
                                            ...
                                            gl_panel_2
                                                ...
                                                .addGroup(
                                                    gl_panel_2
                                                        .createSequentialGroup()
                                                        .addComponent(
                                                            spinner_15, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addPreferredGap(ComponentPlacement.RELATED)
                                                        .addComponent(
                                                            label, GroupLayout.PREFERRED_SIZE, 57,
                                                            GroupLayout.PREFERRED_SIZE))
                                                .addGroup(
                                                    gl_panel_2
                                                        .createSequentialGroup()
                                                        .addComponent(
                                                            spinner_16, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addPreferredGap(
                                                            ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE,
                                                            Short.MAX_VALUE)
                                                        .addComponent(
                                                            label_3, GroupLayout.PREFERRED_SIZE, 57,
                                                            GroupLayout.PREFERRED_SIZE))
                                                .addGroup(
                                                    gl_panel_2
                                                        .createSequentialGroup()
                                                        .addComponent(
                                                            spinner_17, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addPreferredGap(
                                                            ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE,
                                                            Short.MAX_VALUE)
                                                        .addComponent(
                                                            label_4, GroupLayout.PREFERRED_SIZE, 57,
                                                            GroupLayout.PREFERRED_SIZE))
                                                .addGroup(
                                                    gl_panel_2
                                                        .createSequentialGroup()
                                                        .addComponent(
                                                            spinner_18, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addPreferredGap(
                                                            ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE,
                                                            Short.MAX_VALUE)
                                                        .addComponent(
                                                            label_5, GroupLayout.PREFERRED_SIZE, 57,
                                                            GroupLayout.PREFERRED_SIZE))
                                                .addGroup(
                                                    gl_panel_2
                                                        .createSequentialGroup()
                                                        .addComponent(
                                                            spinner_19, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addPreferredGap(
                                                            ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE,
                                                            Short.MAX_VALUE)
                                                        .addComponent(
                                                            label_6, GroupLayout.PREFERRED_SIZE, 57,
                                                            GroupLayout.PREFERRED_SIZE)))
                                        ...
                                        .addGroup(
                                            gl_panel_2
                                                .createParallelGroup(Alignment.LEADING)
                                                .addComponent(
                                                    spinner_20, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_21, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_22, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_23, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    spinner_24, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                .createParallelGroup(Alignment.LEADING)
                                                .addComponent(
                                                    label_1, GroupLayout.PREFERRED_SIZE, 88, GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    label_7, GroupLayout.PREFERRED_SIZE, 57, GroupLayout.PREFERRED_SIZE)
                                                .addGroup(
                                                    gl_panel_2
                                                        .createSequentialGroup()
                                                        .addPreferredGap(ComponentPlacement.RELATED)
                                                        .addGroup(
                                                            gl_panel_2
                                                                .createParallelGroup(Alignment.TRAILING, false)
                                                                .addComponent(
                                                                    lblFinanciacin_1, Alignment.LEADING,
                                                                    GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                                                    Short.MAX_VALUE)
                                                                .addComponent(
                                                                    lblRrppNuevo_1, Alignment.LEADING,
                                                                    GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                                                    Short.MAX_VALUE)
                                                                .addComponent(
                                                                    lblOrgHomenaje_1, Alignment.LEADING,
                                                                    GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                                                    Short.MAX_VALUE))))
                                        .addPreferredGap(ComponentPlacement.RELATED))
                                .addGroup(
                                    ...
                                    gl_panel_2
                                        .createSequentialGroup()
                                        .addComponent(
                                            lblEquipoVisitante, GroupLayout.PREFERRED_SIZE, 110,
                            ...
                            gl_panel_2
                                ...
                                .addGroup(
                                    gl_panel_2
                                        .createSequentialGroup()
                                        .addComponent(
                                            spinner_29, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                            GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addComponent(
                                            lblApostar_1, GroupLayout.PREFERRED_SIZE, 57, GroupLayout.PREFERRED_SIZE))
                                .addGroup(
                                    gl_panel_2
                                        .createSequentialGroup()
                                        .addComponent(
                                            spinner_28, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                            GroupLayout.PREFERRED_SIZE).addPreferredGap(ComponentPlacement.RELATED)
                                ...
                                .addGroup(
                                    gl_panel_2
                                        .createSequentialGroup()
                                        .addComponent(
                                            spinner_27, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                            GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addComponent(
                                            lblIncentivo_1, GroupLayout.PREFERRED_SIZE, 57, GroupLayout.PREFERRED_SIZE))
                                .addGroup(
                                    gl_panel_2
                                        .createSequentialGroup()
                                        .addComponent(
                                            spinner_26, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                            GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addComponent(
                                            lblSoborno_1, GroupLayout.PREFERRED_SIZE, 57, GroupLayout.PREFERRED_SIZE))
                                .addGroup(
                                    gl_panel_2
                                        .createSequentialGroup()
                                        .addComponent(
                                            spinner_25, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                            GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addComponent(
                                            label_2, GroupLayout.PREFERRED_SIZE, 87, GroupLayout.PREFERRED_SIZE)))
                        .addGap(5)));
        gl_panel_2
                                            ...
                                            gl_panel_2
                                                ...
                                                .addGroup(
                                                    gl_panel_2
                                                        .createParallelGroup(Alignment.BASELINE)
                                                        .addComponent(
                                                            spinner_1, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(
                                                            lblPintarse, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE))
                                                .addPreferredGap(ComponentPlacement.RELATED)
                                                .addGroup(
                                                    gl_panel_2
                                                        .createParallelGroup(Alignment.BASELINE)
                                                        .addComponent(
                                                            spinner_2, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(
                                                            lblPelea, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE))
                                                .addPreferredGap(ComponentPlacement.RELATED)
                                                .addGroup(
                                                    gl_panel_2
                                                        .createParallelGroup(Alignment.BASELINE)
                                                        .addComponent(
                                                            spinner_3, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(
                                                            lblPancarta, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE))
                                                .addPreferredGap(ComponentPlacement.RELATED)
                                                .addGroup(
                                                    gl_panel_2
                                                        .createParallelGroup(Alignment.BASELINE)
                                                        .addComponent(
                                                            spinner_4, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(
                                                            lblPromocionarEquipo, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE)))
                                        .addGroup(
                                            gl_panel_2
                                                .createSequentialGroup()
                                                .addGroup(
                                                    gl_panel_2
                                                        .createParallelGroup(Alignment.BASELINE)
                                                        .addComponent(
                                                            spinner_10, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(
                                                            lblMejorargradas, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(
                                                            spinner_15, GroupLayout.PREFERRED_SIZE,
                                                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(
                                                            label, GroupLayout.PREFERRED_SIZE, 14,
                                                            GroupLayout.PREFERRED_SIZE))
                                                .addPreferredGap(ComponentPlacement.RELATED)
                                                .addGroup(
                                                    gl_panel_2
                                                                ...
                                                                .addGroup(
                                                                    gl_panel_2
                                                                        ...
                                                                        .addComponent(
                                                                            ...
                                                                            GroupLayout.PREFERRED_SIZE)
                                                                        .addComponent(
                                                                            lblSoborno, GroupLayout.PREFERRED_SIZE, 14,
                                                                            GroupLayout.PREFERRED_SIZE))
                                                                .addPreferredGap(ComponentPlacement.RELATED)
                                                                .addGroup(
                                                                    gl_panel_2
                                                                        ...
                                                                        .addComponent(
                                                                            ...
                                                                            GroupLayout.PREFERRED_SIZE)
                                                                        .addComponent(
                                                                            lblIncentivo, GroupLayout.PREFERRED_SIZE,
                                                                ...
                                                                .addGroup(
                                                                    gl_panel_2
                                                                        ...
                                                                        .addComponent(
                                                                            ...
                                                                            GroupLayout.PREFERRED_SIZE)
                                                                        .addComponent(
                                                                            lblAscenderTr, GroupLayout.PREFERRED_SIZE,
                                                                            14, GroupLayout.PREFERRED_SIZE))
                                                                .addPreferredGap(ComponentPlacement.RELATED)
                                                                .addGroup(
                                                                    gl_panel_2
                                                                        ...
                                                                        .addComponent(
                                                                            ...
                                                                            GroupLayout.PREFERRED_SIZE)
                                                                        .addComponent(
                                                                            lblApostar, GroupLayout.PREFERRED_SIZE, 14,
                                                                            GroupLayout.PREFERRED_SIZE)))
                                                        .addGroup(
                                                            gl_panel_2
                                                                .createSequentialGroup()
                                                                .addGroup(
                                                                    gl_panel_2
                                                                        ...
                                                                        .addComponent(
                                                                            ...
                                                                            GroupLayout.PREFERRED_SIZE)
                                                                        .addComponent(
                                                                            label_3, GroupLayout.PREFERRED_SIZE, 14,
                                                                            GroupLayout.PREFERRED_SIZE))
                                                                .addPreferredGap(ComponentPlacement.RELATED)
                                                                .addGroup(
                                                                    gl_panel_2
                                                                        ...
                                                                        .addComponent(
                                                                            ...
                                                                            GroupLayout.PREFERRED_SIZE)
                                                                        .addComponent(
                                                                            label_4, GroupLayout.PREFERRED_SIZE, 14,
                                                                            GroupLayout.PREFERRED_SIZE))
                                                                .addPreferredGap(ComponentPlacement.RELATED)
                                                                .addGroup(
                                                                    gl_panel_2
                                                                        ...
                                                                        .addComponent(
                                                                            ...
                                                                            GroupLayout.PREFERRED_SIZE)
                                                                        .addComponent(
                                                                            label_5, GroupLayout.PREFERRED_SIZE, 14,
                                                                            GroupLayout.PREFERRED_SIZE))
                                                                .addPreferredGap(ComponentPlacement.RELATED)
                                                                .addGroup(
                                                                    gl_panel_2
                                                                        ...
                                                                        .addComponent(
                                                                            ...
                                                                            GroupLayout.PREFERRED_SIZE)
                                                                        .addComponent(
                                                                            label_6, GroupLayout.PREFERRED_SIZE, 14,
                                                                            GroupLayout.PREFERRED_SIZE))))))
                                .addGroup(
                                    gl_panel_2
                                        .createSequentialGroup()
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    spinner_5, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.PREFERRED_SIZE).addComponent(lblHackearpagina))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                .createParallelGroup(Alignment.BASELINE)
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblOrgCena, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblOrgHomenaje, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblRrppNuevo, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblFinanciacin, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE)))
                                .addGroup(
                                    gl_panel_2
                                        .createSequentialGroup()
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    label_1, GroupLayout.PREFERRED_SIZE, 14, GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                .createParallelGroup(Alignment.BASELINE)
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    label_7, GroupLayout.PREFERRED_SIZE, 14, GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                .createParallelGroup(Alignment.BASELINE)
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblOrgHomenaje_1, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblRrppNuevo_1, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblFinanciacin_1, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE)))
                                .addGroup(
                                    gl_panel_2
                                        .createSequentialGroup()
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    label_2, GroupLayout.PREFERRED_SIZE, 14, GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                .createParallelGroup(Alignment.BASELINE)
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblSoborno_1, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblIncentivo_1, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblAscenderTrb, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(ComponentPlacement.RELATED)
                                        .addGroup(
                                            gl_panel_2
                                                ...
                                                .addComponent(
                                                    ...
                                                    GroupLayout.PREFERRED_SIZE)
                                                .addComponent(
                                                    lblApostar_1, GroupLayout.PREFERRED_SIZE, 14,
                                                    GroupLayout.PREFERRED_SIZE))))
                        .addGroup(
                            gl_panel_2
                                .createParallelGroup(Alignment.LEADING)
                                .addGroup(
                                    gl_panel_2
                                        ...
                                        .addGap(31)
                                        .addComponent(
                                            lblEquipoLocal, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                            Short.MAX_VALUE)
                                        .addGap(11)
                                        .addComponent(
                                            btnCargar, GroupLayout.PREFERRED_SIZE, 43, GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(
                                    gl_panel_2
                                        ...
                                        .addGap(18)
                                        .addComponent(
                                            lblEquipoVisitante, GroupLayout.PREFERRED_SIZE, 42,
